...
output "pub_net_interface1_id" {
  value = "${aws_network_interface.my_pub_net_interface1.id}"  
}

output "pub_net_interface2_id" {
  value = "${aws_network_interface.my_pub_net_interface2.id}"  
}
